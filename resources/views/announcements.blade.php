        ...
        @foreach ($announcements as $announcement)
            <section class="p-1">
                <div class="flex gap-4 items-start rounded-4xl bg-white p-6 shadow-gray-400 ring-1 ring-slate-100">
                    ...
                    <img class="flex justify-center items-center h-16 w-16 rounded-2xl object-cover ring-2 ring-red-200" src="csc_logo.png">
                    <div class="flex-1 gap-4 grow justify-between">
                        <div class="flex-1 gap-8">
                        <div class="flex gap-2">
                            <h3 class="text-2xl font-bold ">{{ $announcement->title }}</h3>
                            <!--Green thing-->
                            <div class="rounded-2xl items-center bg-green-200 shrink">
                            <p class="font-bold text-green-800 py-1 px-2">Published</p>
                            </div>
                        </div>
